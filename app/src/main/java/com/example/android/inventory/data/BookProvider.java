...
public class BookProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        // TODO: Create and initialize a BookDbHelper object to gain access to the store database.
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // Check that the price is valid, has to be greater than 0
        ...
        // Check that the quantity is valid, could be greater or equal than 0
        ...
        // Insert a new book into the bookss database table with the given ContentValues
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link PetEntry#COLUMN_BOOK_SUPPLIER_PHONE_NUMBER} key is present,
        // check that the Supplier Phone value is valid.
