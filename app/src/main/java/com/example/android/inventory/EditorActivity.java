...
public class EditorActivity extends AppCompatActivity implements
     ...
     * 0 for unknown, 1 nonfiction gender, 2 for fiction
     */
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_nonfiction))) {
                        mGender = BookEntry.GENDER_NONFICTION; // Non Fiction
                    } else if (selection.equals(getString(R.string.gender_fiction))) {
                        mGender = BookEntry.GENDER_FICTION; // Female
                    } else {
    ...
    private void saveBook() {
        ...
        if (mCurrentBookUri == null &&
                ...
                TextUtils.isEmpty(supplierPhoneString) && mGender == BookEntry.GENDER_UNKNOWN) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int genderColumnIndex = cursor.getColumnIndex(BookEntry.COLUMN_BOOK_GENDER);
            ...
            switch (gender) {
                case BookEntry.GENDER_UNKNOWN:
                    mGenderSpinner.setSelection(0);
                    break;
                case BookEntry.GENDER_NONFICTION:
